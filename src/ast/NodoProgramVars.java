...
public class NodoProgramVars extends NodoBase{
	...
	public NodoProgramVars(String name_program, NodoBase vars)
	{
		super();
	...
	public NodoProgramVars(String name_program, NodoBase vars, NodoBase functions)
	{
		super();
		this.name_program = name_program;
		this.vars = vars;
	...
	public NodoProgramVars(String name_program, NodoBase vars, NodoBase functions, NodoBase procedures)
	{
		super();
		this.name_program = name_program;
		this.vars = vars;
	...
	public NodoProgramVars(String name_program, NodoBase vars, NodoBase functions, NodoBase procedures, NodoBase body_programs)
	{
		super();
		this.name_program = name_program;
		this.vars = vars;
		this.functions = functions;
		this.procedures = procedures;
		this.body_program = body_programs;
	}
