...
public class NodoProgramBody extends NodoBase{
	...
	public NodoProgramBody(String name_program, NodoBase body_program)
	{
		super();
	...
	public NodoProgramBody(String name_program, NodoBase vars, NodoBase body_program)
	{
		super();
		this.name_program = name_program;
		this.vars = vars;
	...
	public NodoProgramBody(String name_program, NodoBase vars, NodoBase functions, NodoBase body_program)
	{
		super();
		this.name_program = name_program;
		this.vars = vars;
	...
	public NodoProgramBody(String name_program, NodoBase vars, NodoBase functions, NodoBase procedures, NodoBase body_program)
	{
		super();
		this.name_program = name_program;
		this.vars = vars;
