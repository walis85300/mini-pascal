...
public class NodoProgramProcedures extends NodoBase{
	...
	public NodoProgramProcedures(String name_program, NodoBase procedures)
	{
		super();
	...
	public NodoProgramProcedures(String name_program, NodoBase vars, NodoBase procedures)
	{
		super();
		this.name_program = name_program;
		this.vars = vars;
	...
	public NodoProgramProcedures(String name_program, NodoBase vars, NodoBase functions, NodoBase procedures)
	{
		super();
		this.name_program = name_program;
		this.vars = vars;
	...
	public NodoProgramProcedures(String name_program, NodoBase vars, NodoBase functions, NodoBase procedures, NodoBase body_program)
	{
		super();
		this.name_program = name_program;
		this.vars = vars;
